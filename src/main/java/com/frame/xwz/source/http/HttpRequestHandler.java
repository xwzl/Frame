...
import com.frame.xwz.source.handler.MyRequestHandler;
...
import static com.frame.xwz.source.exception.ComponentConstance.FAVICON;
...
public class HttpRequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest req) throws Exception {
        ...
        MyPort port = (MyPort) single.get("com.frame.xwz.source.http.MyPort");
